...
$$
 M_{изг II}^{\Sigma} = \sqrt{{M_{3 изг окр II }(L_{II 1} + L_{II 2})}^2 + {M_{3 изг рад II }(L_{II 1} + L_{II 2})}^2}  =  \sqrt{M_{3*(и*(з*(г*(о*(к*(р*(I*I)))))))}^{2}{\left(19.32 + 22.5 \right)} + M_{3*(и*(з*(г*(р*(а*(д*(I*I)))))))}^{2}{\left(19.32 + 22.5 \right)}} = 21.2293 
$$
...
$$
 S_{1 окр II} = \frac{1}{2} \cdot M_{1 изг окр II}(L_{II 1}) \cdot L_{II 1}  =  \frac{M_{1*(и*(з*(г*(о*(к*(р*(I*I)))))))}{\left(19.32 \right)} 19.32}{2} = 115.92013 
$$


$$
 S_{2 окр II} = M_{2 изг окр II}(L_{II 1}) \cdot L_{II 2}  =  22.5 M_{2*(и*(з*(г*(о*(к*(р*(I*I)))))))}{\left(19.32 \right)} = 270.00029 
$$


$$
 S_{3 окр II} = \frac{1}{2} \cdot (M_{2 изг окр II}(L_{II 1}) - M_{2 изг окр II}(L_{II 1} + L_{II 2})) \cdot L_{II 1}  =  \frac{\left(- M_{2*(и*(з*(г*(о*(к*(р*(I*I)))))))}{\left(19.32 + 22.5 \right)} + M_{2*(и*(з*(г*(о*(к*(р*(I*I)))))))}{\left(19.32 \right)}\right) 19.32}{2} = 308.62807 
$$


$$
 S_{4 окр II} = \frac{1}{2} \cdot M_{3 изг окр II}(L_{II 1} + L_{II 2}) \cdot L_{II 3}  =  \frac{3.2 M_{3*(и*(з*(г*(о*(к*(р*(I*I)))))))}{\left(19.32 + 22.5 \right)}}{2} = -31.9185 
$$
...
$$
 S_{1 рад II} = \frac{1}{2} \cdot M_{1 изг рад II}(L_{II 1}) \cdot L_{II 1}  =  \frac{M_{1*(и*(з*(г*(р*(а*(д*(I*I)))))))}{\left(19.32 \right)} 19.32}{2} = 42.19071 
$$


$$
 S_{2 рад II} = M_{2 изг рад II}(L_{II 1}) \cdot L_{II 2}  =  22.5 M_{2*(и*(з*(г*(р*(а*(д*(I*I)))))))}{\left(19.32 \right)} = 98.27028 
$$


$$
 S_{3 рад II} = \frac{1}{2} \cdot (M_{2 изг рад II}(L_{II 1}) - M_{2 изг рад II}(L_{II 1} + L_{II 2})) \cdot L_{II 1}  =  \frac{\left(- M_{2*(и*(з*(г*(р*(а*(д*(I*I)))))))}{\left(19.32 + 22.5 \right)} + M_{2*(и*(з*(г*(р*(а*(д*(I*I)))))))}{\left(19.32 \right)}\right) 19.32}{2} = 112.32939 
$$


$$
 S_{4 рад II} = \frac{1}{2} \cdot M_{3 изг рад II}(L_{II 1} + L_{II 2}) \cdot L_{II 3}  =  \frac{3.2 M_{3*(и*(з*(г*(р*(а*(д*(I*I)))))))}{\left(19.32 + 22.5 \right)}}{2} = -11.61717 
$$
...
$$
 y_{1 II} = \frac{y_{ц.т.1 II} \cdot M_{1 изг ед II}(L_{II 1} + L_{II 2})}{L_{II 1} + L_{II 2}}  =  12.88 M_{1*(и*(з*(г*(е*(д*(I*I))))))}{\left(19.32 + 22.5 \right)} \left(19.32 + 22.5\right)^{-1} = 0.02189 
$$


$$
 y_{2 II} = \frac{y_{ц.т.2 II} \cdot M_{1 изг ед II}(L_{II 1} + L_{II 2})}{L_{II 1} + L_{II 2}}  =  30.57 M_{1*(и*(з*(г*(е*(д*(I*I))))))}{\left(19.32 + 22.5 \right)} \left(19.32 + 22.5\right)^{-1} = 0.05196 
$$


$$
 y_{3 II} = \frac{y_{ц.т.3 II} \cdot M_{1 изг ед II}(L_{II 1} + L_{II 2})}{L_{II 1} + L_{II 2}}  =  34.32 M_{1*(и*(з*(г*(е*(д*(I*I))))))}{\left(19.32 + 22.5 \right)} \left(19.32 + 22.5\right)^{-1} = 0.05833 
$$


$$
 y_{4 II} = \frac{(L_{II 3} - (y_{ц.т.4 II} - L_{II 1} - L_{II 2})) \cdot M_{2 изг ед II}(L_{II 1} + L_{II 2})}{L_{II 3}}  =  3.2^{-1} \left(- (- 19.32 - 22.5 + 42.88667) + 3.2\right) M_{2*(и*(з*(г*(е*(д*(I*I))))))}{\left(19.32 + 22.5 \right)} = 1.9817 
$$
...
$$
 \delta_{yOz II} = \frac{S_{1 окр II} \cdot y_{1 II} + S_{2 окр II} \cdot y_{2 II} + S_{3 окр II} \cdot y_{3 II} + S_{4 окр II} \cdot y_{4 II}}{E \cdot J_{p II} }  =  \left(0.02189 \cdot 115.92013 + 0.05196 \cdot 270.00029 + 0.05833 \cdot 308.62807 + 1.9817 \left(-31.9185\right)\right) 25.6^{-1} \left(2.1 \cdot 10^{5}\right)^{-1} = -1e-05 
$$


$$
 \delta_{xOz II} = \frac{S_{1 рад II} \cdot y_{1 II} + S_{2 рад II} \cdot y_{2 II} + S_{3 рад II} \cdot y_{3 II} + S_{4 рад II} \cdot y_{4 II}}{E \cdot J_{p II} }  =  \left(0.02189 \cdot 42.19071 + 0.05196 \cdot 98.27028 + 0.05833 \cdot 112.32939 + 1.9817 \left(-11.61717\right)\right) 25.6^{-1} \left(2.1 \cdot 10^{5}\right)^{-1} = -0.0 
$$
...
$$
 J_{пр} = J_р + J_{р.пр.} + \frac{J_{н}}{{i_0}^2}  =  0.0 + 3.6 \cdot 10^{-6} + 53.57143^{-2} \cdot 0.0038241 = 1e-05 
$$



$$
 T_{ЭМ} = \frac{J_{пр} \cdot \omega_{н}}{M_{пуск} - M_{с.пр.}}  =  1.0 \cdot 10^{-5} \cdot 8.79646 \left(- 8.16667 + 118\right)^{-1} = 0.0 
$$



$$
 t_p = 3 T_{ЭМ}  =  3 \cdot 0.0 = 0.0 
$$
...
$$
 \sigma_{H конт 2} = \zeta_H \cdot \zeta_M \cdot \zeta_{\xi} \cdot \sqrt{\frac{M_{II} \cdot K_{комп} \cdot (1 + i_{12})}{2 b_{2} \cdot i_{12}^2 \cdot a_{\omega 12}^2}}  =  \frac{\sqrt{2} \cdot 1.76394 \cdot 0.9 \cdot 86 \sqrt{61.77997 \cdot 34.2^{-2} \cdot 4.0^{-1} \cdot 1.4 \cdot \left(1 + 7.14285714285\right) \left(7.14285714285^{2}\right)^{-1}}}{2} = 5.24395 
$$


$$
 \sigma_{H конт 4} = \zeta_H \cdot \zeta_M \cdot \zeta_{\xi} \cdot \sqrt{\frac{M_{III} \cdot K_{комп} \cdot (1 + i_{34})}{2 b_{4} \cdot i_{34}^2 \cdot a_{\omega 34}^2}}  =  \frac{\sqrt{2} \cdot 1.76394 \cdot 0.9 \cdot 86 \sqrt{451.10043 \cdot 68.0^{-2} \cdot 8.0^{-1} \cdot 1.4 \cdot \left(1 + 7.5\right) \left(7.5^{2}\right)^{-1}}}{2} = 4.90349 
$$
...
Проверка:
$$
 \sigma_{H конт 2} \cdot \sqrt{K_{пер}} \leq [\sigma_{H II max}]
$$

$$
 \sigma_{H конт 4} \cdot \sqrt{K_{пер}} \leq [\sigma_{H III max}]\\\sqrt{13.498975} \cdot 4.903489 \leq 1876.0
$$
